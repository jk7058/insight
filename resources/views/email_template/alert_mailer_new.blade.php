            ...
            <thead>
                <tr>
                    <th style="padding:20px 30px 0;text-align: center;">
                        <img src="{{ asset('images/emailer-logo.png') }}" width="220" height="73" alt="insightsPRO Logo" style="display: block;margin-left: auto;margin-right: auto;max-width:60%;height: auto;" />
                    </th>
                </tr>
                <tr>
                            ...
                            <tbody>
                                <?php if(isset($call_id) && (!empty($call_id))){?>
                                    <tr>
                                        ...
                                        <td style="border:1px solid #dcdcdc;padding:10px 12px;width:65%;font-size: 11px;vertical-align: middle;"><?php echo $call_id;?></td>
                                    </tr>
                                <?php } ?>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0px solid" width="560" style="margin:0 auto;width: 560px;max-width:90%;border-collapse: collapse;border:0px solid transparent;">
                                <thead>
                                    <tr style="border-bottom: transparent;">
                                        ...
                                        <th style="border:1px solid #dcdcdc;background-color:#efefef;font-size:12px;vertical-align:middle;padding:10px;font-weight:600;color:#565656;">Option</th>
                                    </tr>
                                </thead>
                                <tbody>
