...
class AlertNotificationController extends Controller
{
     ...
     *
     * @param  \App\Models\AlertNotification  $alertNotification
     * @return \Illuminate\Http\Response
     */
    public function show(AlertNotification $alertNotification)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(AlertNotification $alertNotification)
    {
        //
    }
}
